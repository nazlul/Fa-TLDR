    ...
    <div className="flex justify-around items-center h-14">
      ...
      >
        ...
        <span className="text-xs mt-1">Context</span>
             ...
             <button
         onClick={() => setActiveTab(Tab.Summarizer)}
         className={`flex flex-col items-center justify-center w-full h-full ${
           activeTab === Tab.Summarizer ? 'text-primary dark:text-primary-light' : 'text-gray-500 dark:text-gray-400'
         }`}
       >
         <span className="text-xl">⚡</span>
         <span className="text-xs mt-1">TLDR</span>
       </button>
      {showWallet && (
        <button
